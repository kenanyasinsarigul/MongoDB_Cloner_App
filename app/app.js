...
const SchedulelarService = require("./components/scheduleConfig/service/SchedulelarService");
...
app.use("/api/environment", require("./components/environment/controller/Environment"));
app.use("/api/job", require("./components/job/controller/Job"));
app.use("/api/job-item", require("./components/job-item/controller/JobItem"));
app.use("/api/schedule-config", require("./components/scheduleConfig/controller/ScheduleConfig"));
app.use("/", router);
